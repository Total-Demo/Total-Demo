package com.barry.droolsdemo.generator;
...
import com.barry.droolsdemo.manager.FactManager;
import com.barry.droolsdemo.utils.DateUtil;
...
//        模板文件生成drl String
    ...
    protected Map<String, Object> prepareData(RuleDTO ruleDTO) {
        ...
        data.put("beginTime", DateUtil.dateToStringFormat(ruleDTO.getBeginTime(), "yyyy-MM-dd"));
        data.put("endTime", DateUtil.dateToStringFormat(ruleDTO.getEndTime(), "yyyy-MM-dd"));
        ...
        data.put("action", "com.barry.droolsdemo.service.PrizeSendService");
